...
if not internet():
    print('no internet')
    ssid = input('enter username')
    wifipw = input('enter password')
...
def addToCart():
    ...
    data2 = '{"productCodePost":"P_' + array[0] + '","productCode":"P_' + array[
        0] + '","sellingMethod":"BY_UNIT","qty":"1","frontQuantity":"1","comment":"","affiliateCode":""}'
